...
export const serviceCategoriesList: ServiceCategoryMeta[] = [
  {
    ...
    shortDescription: {
      en: 'Enterprise firewall management, active endpoint threat defense, encrypted VPNs, and comprehensive security audits.',
      pt: 'Gestão de firewalls empresariais, defesa ativa de postos de trabalho, VPNs encriptadas e auditorias de cibersegurança.'
    },
  ...
  },
  {
    ...
    shortDescription: {
      en: 'Professional structured cabling, 10GbE switching, and high-density enterprise Wi-Fi 6 mesh deployments.',
      pt: 'Instalação de cablagem estruturada certificada, switching 10GbE e redes Wi-Fi 6 empresariais de alta densidade.'
    },
    iconName: 'Network',
  ...
  },
  {
    ...
    shortDescription: {
      en: 'Reliable on-site dispatch, remote helpdesk, workstation repairs, and preventive thermal maintenance for business computers.',
      pt: 'Assistência no local, helpdesk remoto, reparação de bancada e manutenção preventiva para computadores e empresas.'
    },
    iconName: 'Wrench',
  ...
  },
  {
    ...
    index: '04',
    title: {
      en: 'Server & Data Center Solutions',
      pt: 'Servidores & Soluções Datacenter'
    },
    shortDescription: {
      en: 'Deployment, RAID arrays, virtualization, and immutable air-gapped backup storage for business servers.',
      pt: 'Implementação de servidores rack, matrizes RAID, virtualização e sistemas de backup imutáveis à prova de desastres.'
    },
    iconName: 'Server',
...
export const allServicesData: ServiceItem[] = [
  ...
  // ==========================================
  {
    id: 'srv-cybersecurity-flagship',
    slug: 'cybersecurity',
    title: 'Cybersecurity & UTM Firewalls',
    ...
    shortDescription: 'Enterprise UTM firewall deployment, encrypted VPNs, active EDR threat monitoring, and ransomware-proof backups.',
    shortDescriptionPt: 'Implementação de firewalls UTM, VPNs encriptadas, proteção EDR de postos e backups à prova de ransomware.',
    fullDescription: 'Our certified cybersecurity engineers protect your business with multi-layered perimeter firewalls, zero-trust remote work VPNs, continuous workstation telemetry, and air-gapped immutable backup architectures.',
    iconName: 'ShieldCheck',
    deliveryModes: ['Remote', 'On-Site'],
    turnaroundTime: { en: 'SLA < 2h Response', pt: 'Resposta SLA < 2h' },
    deliverables: {
      en: ['Next-Gen UTM firewall policy', 'Encrypted WireGuard / IPsec VPN setup', 'Immutable air-gapped backup validation'],
      pt: ['Configuração de firewall UTM de nova geração', 'Túneis VPN encriptados WireGuard / IPsec', 'Validação de backups imutáveis isolados']
    },
    capabilities: [
      'Fortinet FortiGate & Sophos XGS Next-Gen Firewall implementation with SSL inspection',
      'Bank-grade encrypted Site-to-Site and remote worker WireGuard / IPsec VPN tunnels with MFA',
      'AI-driven Endpoint Detection & Response (EDR) with real-time workstation quarantine',
      'Air-gapped immutable backups ensuring 100% ransomware recovery guarantee',
      'Vulnerability scanning, port audits, and ISO 27001 / GDPR compliance roadmaps'
    ],
    processSteps: [
      { title: 'Security Architecture Audit', description: 'Assessing perimeter risks, open ports, and data assets.' },
      { title: 'Perimeter & Endpoint Hardening', description: 'Deploying hardware firewalls, VPNs, and managed EDR.' },
      { title: 'Immutable Backup Verification', description: 'Configuring air-gapped snapshots with disaster restore tests.' },
      { title: 'Continuous Threat Guard', description: 'Real-time telemetry and priority incident response under 2 hours.' }
    ],
    businessValue: [
      'Shield company servers and customer databases from automated ransomware attacks',
      'Enable secure hybrid and remote work without opening risky open ports to the internet',
      'Comply with corporate insurance, GDPR, and enterprise security standards'
    ],
    slaNote: 'Priority response in under 2 hours for active threat emergencies.',
    featured: true
  },
  {

...
export const megaMenuServicesPagesData: Record<string, MegaMenuPageData> = {
  // 0. CYBERSECURITY & UTM FIREWALLS
  'cybersecurity': {
    slug: 'cybersecurity',
    categoryBadgeEn: 'ENTERPRISE CYBERSECURITY & THREAT DEFENSE',
    categoryBadgePt: 'CIBERSEGURANÇA EMPRESARIAL & DEFESA PERIMETRAL',
    headerTitleEn: 'We Provide Complete Enterprise Cybersecurity & Firewall Services',
    headerTitlePt: 'Serviços Especializados de Cibersegurança, Firewalls e Proteção de Dados',
    headerDescEn: 'Protect your business infrastructure, remote workforce, and confidential databases with next-generation UTM firewalls, encrypted VPNs, active EDR threat monitoring, and zero-loss ransomware recovery.',
    headerDescPt: 'Proteja a infraestrutura da sua empresa, equipas remotas e bases de dados confidenciais com firewalls UTM de última geração, VPNs encriptadas, monitorização EDR ativa e recuperação à prova de ransomware.',
    cardsCountTextEn: '6 Specialized Cybersecurity Services',
    cardsCountTextPt: '6 Serviços Especializados de Cibersegurança',
    cards: [
      {
        id: 'cyber-1',
        slug: 'cybersecurity',
        titleEn: 'Next-Gen Firewall & UTM Defense',
        titlePt: 'Firewalls de Nova Geração & UTM',
        descEn: 'Fortinet FortiGate and Sophos XGS deployment with continuous SSL/TLS Deep Packet Inspection, IPS rules, and automated threat isolation.',
        descPt: 'Implementação de Fortinet FortiGate e Sophos XGS com inspeção profunda SSL/TLS, regras de IPS e isolamento automático de intrusões.',
      ...
      },
      {
        id: 'cyber-2',
        slug: 'cybersecurity',
        titleEn: 'Encrypted Remote Work & VPN',
        titlePt: 'Acesso Remoto Seguro & VPN',
        descEn: 'Bank-grade 256-bit encrypted Site-to-Site and remote worker WireGuard / IPsec tunnels with mandatory Multi-Factor Authentication (MFA).',
        descPt: 'Túneis VPN encriptados Site-to-Site e para colaboradores remotos (WireGuard / IPsec) com autenticação de dois fatores (MFA).',
        iconName: 'Lock',
      ...
      },
      {
        id: 'cyber-3',
        slug: 'cybersecurity',
        titleEn: 'Managed Endpoint EDR & Threat Shield',
        titlePt: 'Proteção de Postos EDR & Anti-Ransomware',
        descEn: 'AI-driven Next-Gen Antivirus and Endpoint Detection & Response (EDR) with real-time workstation quarantine and behavioral blocking.',
        descPt: 'Antivírus de nova geração com inteligência artificial e EDR para proteção de computadores e isolamento instantâneo de ameaças.',
        iconName: 'Laptop',
        image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=600&q=80',
        turnaroundEn: 'Active 24/7',
        turnaroundPt: 'Ativo 24/7',
        badgeIndex: '03'
      },
      {
        id: 'cyber-4',
        slug: 'cybersecurity',
        titleEn: 'Vulnerability Assessment & Audit',
        titlePt: 'Auditoria de Vulnerabilidades & RGPD',
        descEn: 'In-depth external/internal port scanning, CVE vulnerability analysis, password audits, and actionable ISO 27001 / GDPR compliance roadmap.',
        descPt: 'Varredura exaustiva de vulnerabilidades, portas abertas, testes de conformidade RGPD e relatório com plano de correção prioritário.',
        iconName: 'Search',
      ...
      },
      {
        id: 'cyber-5',
        slug: 'cybersecurity',
        titleEn: 'Immutable Air-Gapped Backups',
        titlePt: 'Backups Imutáveis & Continuidade',
        descEn: 'Write-Once-Read-Many (WORM) air-gapped backup storage that protects financial databases and files from encryption or deletion by ransomware.',
        descPt: 'Repositórios de cópias de segurança imutáveis e isoladas (Air-Gapped) garantindo recuperação total de desastres sem perda de dados.',
        iconName: 'HardDrive',
        image: 'https://images.unsplash.com/photo-1597872200969-2b65d56bd16b?auto=format&fit=crop&w=600&q=80',
        turnaroundEn: 'Zero-loss SLA',
        turnaroundPt: 'Garantia Zero Perda',
        badgeIndex: '05'
      },
      {
        id: 'cyber-6',
        slug: 'cybersecurity',
        titleEn: 'Email Security & Anti-Phishing Defense',
        titlePt: 'Segurança de Email & Anti-Phishing',
        descEn: 'Advanced SPF, DKIM, and DMARC enforcement, display-name spoofing protection, malicious attachment sandboxing, and staff awareness simulations.',
        descPt: 'Configuração rigorosa de SPF/DKIM/DMARC, proteção contra falsificação de faturas, análise de anexos e testes de sensibilização.',
        iconName: 'Layers',
    ...
    spotlight: {
      badgeEn: 'CYBERSECURITY & ENTERPRISE DEFENSE',
      badgePt: 'CIBERSEGURANÇA & DEFESA PERIMETRAL EMPRESARIAL',
      titleEn: 'Protect Your Business. Reduce Your Risk.',
      titlePt: 'Proteja a Sua Empresa. Reduza o Seu Risco.',
      paragraphEn: 'Cyber threats, extortion ransomware, and phishing attacks pose critical risks to modern businesses. Our certified cybersecurity engineers design and deploy multi-layered perimeter defenses, bank-grade encrypted VPNs, active EDR workstation protection, and air-gapped immutable backups to guarantee 100% operational resilience.',
      paragraphPt: 'Ameaças cibernéticas, ransomware de extorsão e ataques de phishing colocam em risco a continuidade do seu negócio. Os nossos engenheiros de cibersegurança implementam defesas perimétricas multi-camada, VPNs encriptadas de nível bancário, proteção EDR ativa e backups imutáveis à prova de ransomware para garantir total resiliência operacional.',
      image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=1200&q=80',
      imageAlt: 'Enterprise Next-Generation Firewall and Network Security Infrastructure',
      imageBadgeEn: 'ISO 27001 Aligned • Active Threat Response SLA < 2h',
      imageBadgePt: 'Alinhamento ISO 27001 • SLA de Resposta Ativa < 2h',
      featuresEn: [
        'Dedicated Next-Gen Hardware Firewalls (Fortinet & Sophos) with deep packet inspection',
        'Bank-grade encrypted WireGuard / IPsec VPN tunnels with Multi-Factor Authentication (MFA)',
        'AI-driven Endpoint Detection & Response (EDR) active workstation shield & isolation',
        'Air-gapped immutable backup architecture with 100% zero-ransomware recovery guarantee'
      ],
      featuresPt: [
        'Firewalls dedicadas de nova geração (Fortinet & Sophos) com inspeção profunda de pacotes',
        'Túneis VPN encriptados WireGuard / IPsec com Autenticação de Dois Fatores (MFA)',
        'Proteção ativa de postos de trabalho com Antivírus EDR e isolamento automático',
        'Repositórios de backup imutáveis isolados com garantia total contra ransomware'
      ],
      ctaTextEn: 'Request Cybersecurity Quote',
      ctaTextPt: 'Pedir Proposta de Cibersegurança'
    }
  },

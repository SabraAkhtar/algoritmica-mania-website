...
export const productsData: Product[] = [
  ...
  // 8. Cyber Security Hardware Products
  {
    id: 'prod-fortinet-fortigate-60f',
    slug: 'fortinet-fortigate-60f-secure-router',
    name: 'Fortinet FortiGate 60F Enterprise Security Router',
    brand: 'Fortinet',
    category: 'cybersecurity',
    subCategory: 'Cyber Security Router',
    condition: 'Refurbished - Grade A+',
    keySpecs: '10x GE RJ45 Ports • 1 Gbps Threat Protection • 700 Mbps SSL VPN • ASIC SOC4 Powered',
    description: 'High-performance desktop cybersecurity router and firewall providing integrated secure routing, SD-WAN, and enterprise perimeter protection.',
    price: 490,
    currency: 'EUR',
    availability: 'In Stock',
    images: [
    ...
    features: [
      'Dedicated hardware ASIC SOC4 acceleration for fast encrypted traffic inspection',
      'Dual WAN ports for automatic internet failover and load balancing',
      'Built-in secure SD-WAN and enterprise WireGuard / IPsec VPN gateway'
    ],
    fullSpecs: [
      { label: 'Device Type', value: 'Cyber Security Router & Firewall' },
      { label: 'Firewall Throughput', value: '10 Gbps' },
      { label: 'IPS Throughput', value: '1.4 Gbps' },
      { label: 'NGFW Throughput', value: '1.0 Gbps' },
      { label: 'Interfaces', value: '10x GE RJ45 ports (including 2x WAN, 1x DMZ, 5x Internal, 2x FortiLink)' }
    ],
    portsAndConnectivity: [
      '2x GE RJ45 WAN Ports',
      '1x GE RJ45 DMZ Port',
      '2x GE RJ45 FortiLink Ports',
      '5x GE RJ45 Internal Switch Ports',
      '1x USB Console Port'
    ],
    warrantyMonths: 12,
    featured: true
  ...
  {
    id: 'prod-cisco-catalyst-9200l-secure-switch',
    slug: 'cisco-catalyst-9200l-24p-security-switch',
    name: 'Cisco Catalyst 9200L 24-Port Gigabit PoE+ Security Switch',
    brand: 'Cisco',
    category: 'cybersecurity',
    subCategory: 'Cyber Security Switch',
    condition: 'Refurbished - Grade A+',
    keySpecs: '24x Gigabit PoE+ (370W) • 4x 10G SFP+ Uplinks • 802.1X Port Security • Cisco TrustSec',
    description: 'Enterprise Layer 3 managed security switch equipped with hardware MACsec encryption, 802.1X network access control, and dynamic rogue device isolation.',
    price: 890,
    currency: 'EUR',
    availability: 'In Stock',
    images: [
    ...
    features: [
      'Hardware-enforced 802.1X port authentication and MAC security filters',
      '24 Gigabit PoE+ ports with 370W total power budget for access points and IP cameras',
      '4 high-speed 10G SFP+ optical uplink ports for core datacenter connections'
    ],
    fullSpecs: [
      { label: 'Switch Type', value: 'Enterprise Managed Security Switch' },
      { label: 'Port Count', value: '24x 10/100/1000 Gigabit PoE+ Ports' },
      { label: 'Uplink Ports', value: '4x 10G SFP+ Optical Uplinks' },
      { label: 'PoE Budget', value: '370W Total PoE+' },
      { label: 'Security Features', value: '802.1X, Cisco TrustSec, DAI, DHCP Snooping, Port Security' }
    ],
    portsAndConnectivity: [
      '24x RJ-45 10/100/1000 PoE+ Ports',
      '4x 10G SFP+ Transceiver Slots',
      '1x RJ-45 Serial Console',
      '1x USB-C Console'
    ],
    warrantyMonths: 12,
    featured: true
  ...
  {
    id: 'prod-sophos-xgs-116-gateway',
    slug: 'sophos-xgs-116-security-gateway',
    name: 'Sophos XGS 116 Next-Gen Security Gateway Appliance',
    brand: 'Sophos',
    category: 'cybersecurity',
    subCategory: 'Cyber Security Gateway',
    condition: 'Refurbished - Grade A',
    keySpecs: 'Dual Processor Architecture • Xstream Flow Processor • 8x GbE Copper + 1x SFP • Hardware TLS 1.3 Inspection',
    description: 'Dedicated enterprise security gateway appliance with hardware-accelerated deep packet inspection, zero-trust network access (ZTNA), and automated threat isolation.',
    price: 680,
    currency: 'EUR',
    availability: 'In Stock',
    images: [
    ...
    features: [
      'Xstream architecture accelerates verified SaaS, cloud, and encrypted traffic',
      'Deep packet inspection for TLS 1.3 encrypted web traffic without bottlenecks',
      'Integrated site-to-site IPsec and SSL VPN tunnel management'
    ],
    fullSpecs: [
      { label: 'Appliance Type', value: 'Hardware Security Gateway / UTM Appliance' },
      { label: 'Firewall Throughput', value: '7,700 Mbps' },
      { label: 'Threat Protection', value: '685 Mbps' },
      { label: 'SSL/TLS Inspection', value: '650 Mbps' },
      { label: 'Form Factor', value: 'Desktop / Rack-mount kit included' }
    ],
    portsAndConnectivity: [
      '8x GbE RJ45 Ports',
      '1x GbE SFP Fiber Port',
  ...
  {
    id: 'prod-dell-r340-security-server',
    slug: 'dell-poweredge-r340-security-server',
    name: 'Dell PowerEdge R340 1U Enterprise Security & Log Server',
    brand: 'Dell',
    category: 'cybersecurity',
    subCategory: 'Cyber Security Servers',
    condition: 'Refurbished - Grade A+',
    keySpecs: 'Intel Xeon E-2276G (6C/12T) • 32GB ECC DDR4 • 2x 960GB Enterprise SSD RAID-1 • iDRAC9 Enterprise',
    description: 'Compact 1U rackmount security server optimized for high-throughput SIEM log aggregation, firewall telemetry processing, network monitoring, and air-gapped security services.',
    price: 1090,
    currency: 'EUR',
    availability: 'In Stock',
    images: [
    ...
    features: [
      'Hot-plug dual redundant 350W Platinum power supplies for zero-downtime operations',
      'Hardware PERC H330 RAID controller with dual enterprise SSD mirror for log integrity',
      'Dedicated iDRAC9 Enterprise remote management port with out-of-band security'
    ],
    fullSpecs: [
      { label: 'Server Role', value: 'Dedicated Security Appliance & SIEM Log Server' },
      { label: 'Processor', value: 'Intel Xeon E-2276G (6 Cores, 12 Threads, 3.80 GHz up to 4.90 GHz)' },
      { label: 'Memory', value: '32GB DDR4 ECC UDIMM' },
      { label: 'Storage', value: '2x 960GB Enterprise SATA SSDs in Hardware RAID-1' },
      { label: 'Network', value: '2x 1GbE LOM + Dedicated iDRAC Port' }
    ],
    portsAndConnectivity: [
      '2x 1GbE Onboard RJ45 LOM ports',
      '1x Dedicated iDRAC9 Remote Management port',
      '2x PCIe Gen3 Expansion Slots',
      'Front & Rear USB ports, VGA Display port'
    ],
    warrantyMonths: 12,
    featured: true
  }

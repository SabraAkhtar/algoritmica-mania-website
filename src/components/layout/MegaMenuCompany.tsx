...
export const MegaMenuCompany: React.FC<MegaMenuCompanyProps> = ({
  ...
  return (
    <div 
      className="absolute top-full pt-1.5 left-1/2 -translate-x-1/2 w-80 sm:w-88 z-50 transition-all animate-fadeIn before:content-[''] before:absolute before:-top-3 before:left-0 before:right-0 before:h-4"
    >
      <div className="bg-white rounded-2xl border border-[#CCFBF1] shadow-[0_12px_36px_-6px_rgba(4,47,44,0.14)] p-2 sm:p-2.5">

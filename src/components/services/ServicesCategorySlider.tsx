...
export const allMegaMenuServicesSliderList: ServiceSliderItem[] = [
  {
    ...
    namePt: 'Cibersegurança & Firewalls',
    categoryName: 'Threat Defense',
    categoryNamePt: 'Defesa Perimetral',
    iconName: 'ShieldCheck',
    iconComponent: () => <ShieldCheck className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'Wrench',
    iconComponent: () => <Wrench className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'Sparkles',
    iconComponent: () => <Sparkles className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'Headphones',
    iconComponent: () => <Headphones className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'HardDrive',
    iconComponent: () => <HardDrive className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'Cpu',
    iconComponent: () => <Cpu className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'Zap',
    iconComponent: () => <Zap className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'Laptop',
    iconComponent: () => <Laptop className="w-8 h-8 text-[#0D7E73]" />
  },
  {
    ...
    iconName: 'Network',
    iconComponent: () => <Network className="w-8 h-8 text-[#0D7E73]" />
  }
];

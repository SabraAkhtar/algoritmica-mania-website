...
export const WhatWeDoSection: React.FC<WhatWeDoSectionProps> = ({
  ...
  const getTranslateX = (offset: number) => {
    if (typeof window === 'undefined') return offset * 340;
    const vw = window.innerWidth;
    if (vw < 480) {
      // Mobile: only show center card, push others fully off-screen within overflow-hidden bounds
      if (offset === 0) return 0;
      return offset > 0 ? 320 : -320;
    } else if (vw < 768) {
      // Small tablet
      return offset * 280;
    }
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div 
          ref={containerRef}
          className="relative w-full h-[420px] sm:h-[440px] flex items-center justify-center cursor-grab active:cursor-grabbing px-2 py-4 overflow-hidden"
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between text-left">
                    ...
                    {/* Footer: Learn More Primary Button */}

...
const RotatingText = forwardRef<RotatingTextRef, RotatingTextProps>((props, ref) => {
  ...
  return (
    <motion.span 
      className={cn('inline-flex items-center align-baseline', mainClassName)} 
      {...rest} 
      layout 
      transition={transition}
    >
      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        <motion.span
          ...
          className={cn('inline-flex flex-wrap items-baseline', splitBy === 'lines' ? 'flex-col' : '')}
          layout
          aria-hidden="true"
        >
          {elements.map((wordObj, wordIndex, array) => {
            ...
            return (
              <span key={wordIndex} className={cn('inline-flex items-baseline overflow-hidden', splitLevelClassName)}>

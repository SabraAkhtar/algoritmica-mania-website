...
export const MainLayout: React.FC = () => {
  ...
  const handleNavigateServices = (slug?: string) => {
    if (slug) {
      if (slug === 'cybersecurity') {
        navigate('/services/cybersecurity');
        return;
      }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-sans text-[#1F2933] antialiased selection:bg-[#EAF3F8] selection:text-[#183B56] overflow-x-hidden">
      <ScrollToTop />

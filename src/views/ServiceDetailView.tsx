...
import cybersecurityHeroImg from '../assets/images/cybersecurity_enterprise_hero.jpg';

// Local image overrides per slug — used for spotlight & card images
const localSpotlightImages: Record<string, string> = {
  'cybersecurity': cybersecurityHeroImg,
};
                ...
                >
                  ...
                  <div className="flex-1 p-5 sm:p-6 flex flex-col justify-between min-w-0">
                    <div>
                      ...
                      {/* Service Title */}
                      <h3 className="text-base sm:text-lg font-black text-[#042F2C] group-hover:text-[#0D7E73] transition-colors leading-snug mb-2">
                        {cardTitle}
                      </h3>

                      {/* Short Description */}
                      <p className="text-xs sm:text-[13px] text-slate-500 leading-relaxed line-clamp-3 mb-4">
                        {cardDesc}
                      </p>
                    </div>

                    {/* Learn More Button (Matching Header ActionPrimaryButton) */}
                    <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                      <ActionPrimaryButton
                        type="button"
                        size="sm"
                        glow={false}
                        className="text-xs shrink-0 shadow-2xs hover:shadow-md"
                        onClick={(e) => {
                          e.stopPropagation();
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden border border-slate-200/90 shadow-md aspect-4/3 sm:aspect-16/10 lg:aspect-4/3 group">
                <img
                  src={localSpotlightImages[slug] || megaMenuData.spotlight.image}
